<div class="grid grid-cols-1 gap-4 md:grid-cols-2 py-6 bg-slate-200 m-4 rounded-xl">

    @if($heroInfo)

        <div class="flex flex-col pt-4 md:pt-40 px-10 space-y-4">

            <h1 class="font-black text-5xl">{{ $heroInfo->title }}</h1>
